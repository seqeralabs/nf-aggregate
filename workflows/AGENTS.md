...
Runs in the Nextflow head process (no container). Writes JSON files to `workDir/run_data/`, copies to `workDir/benchmark_data/` dir, passes to `BENCHMARK_REPORT_V2`.
